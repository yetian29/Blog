...
function SmallSetPagination({ get_blog_list_category_page, category_id, count}) {
  ...
  const visitPage = (page) => {
    ...
    setCurrentPage(page);
    setActivePage(page);
    get_blog_list_category_page(category_id, page)
  };
  const previous_number = () => {
    if (currentPage !== 1) {
      ...
      get_blog_list_category_page(category_id, currentPage - 1)
